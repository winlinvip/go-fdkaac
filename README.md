...
* [ExampleAacDecoder_RAW](fdkaac/example_test.go), decode the aac frame to PCM samples.
* [ExampleAacEncoder_LC](fdkaac/example_test.go), encode the PCM samples to aac frame.
